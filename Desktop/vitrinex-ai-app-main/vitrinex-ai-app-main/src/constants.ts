...
// Nomes dos Modelos OpenAI
export const OPENAI_DEFAULT_MODEL = 'gpt-4o-mini';

// Configurações do Ollama
export const OLLAMA_DEFAULT_MODEL = (typeof import.meta !== 'undefined' && (import.meta as any).env?.VITE_OLLAMA_MODEL) || (typeof process !== 'undefined' ? process.env.VITE_OLLAMA_MODEL : '') || 'gpt-oss:120b-cloud';
export const OLLAMA_DEFAULT_BASE_URL = (typeof import.meta !== 'undefined' && (import.meta as any).env?.VITE_OLLAMA_BASE_URL) || (typeof process !== 'undefined' ? process.env.VITE_OLLAMA_BASE_URL : '') || 'http://localhost:11434/v1';


// Modelos de Geração de Imagem
export const IMAGEN_STANDARD_MODEL = 'imagen'; // Imagen 4
export const IMAGEN_ULTRA_MODEL = 'imagen'; 
export const IMAGEN_FAST_MODEL = 'gemini-3.1-flash-image-preview'; // Nano Banana 2
...
export const GEMINI_TTS_FLASH_MODEL = 'gemini-2.5-flash-preview-tts';
export const GEMINI_TTS_PRO_MODEL = 'gemini-2.5-pro-preview-tts';
...
export const HARDCODED_API_KEY = (typeof import.meta !== 'undefined' && (import.meta as any).env?.VITE_GEMINI_API_KEY) || (typeof process !== 'undefined' ? process.env.VITE_GEMINI_API_KEY : '');
export const HARDCODED_OPENAI_KEY = (typeof import.meta !== 'undefined' && (import.meta as any).env?.VITE_OPENAI_API_KEY) || (typeof process !== 'undefined' ? process.env.VITE_OPENAI_API_KEY : '');
